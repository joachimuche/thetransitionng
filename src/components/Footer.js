    ...
    <div className=" mt-[4rem] py-2 bg-black">
      <div>
        <div className="flex flex-col">
          <div className="md:flex md:justify-between px-6 md:my-4 flex">
            ...
            <div>
              <div className="flex justify-center text-3xl items-center py-2">
                <FaFacebookF className="bg-yellow rounded-full p-2 border-none outline-none text-black mx-2" />
                <FaLinkedinIn className="bg-yellow rounded-full p-2 border-none outline-none text-black  mx-2" />
                <FaTwitter className="bg-yellow rounded-full p-2 border-none outline-none text-black mx-2" />
                <FaYoutube className="bg-yellow  rounded-full p-2 border-none outline-none text-black mx-2" />
              </div>
          ...
          <div className="md:flex md:justify-evenly text-yellow font-extralight">
